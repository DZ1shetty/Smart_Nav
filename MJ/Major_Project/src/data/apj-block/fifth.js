...
export const fifth = {
  ...
  bulgeHeight: 500,
  rooms: [
    { id: "staff-room-top", name: "STAFF ROOM (ISE)", x: 380, y: 70, w: 200, h: 80, type: "staffroom", description: "Top level staff workspace", image: "https://placehold.co/600x400?text=Staff+Room+Top", directions: "Top center area.", tags: ["office", "ise"] },
    ...
    { id: "hod-cabin", name: "ISE HOD CABIN", x: 70, y: 680, w: 220, h: 180, type: "staffroom", description: "Head of Department - ISE", image: `${IMG_BASE_URL}/apj-block-images/5th-floor/hod_cabin(ise).jpeg`, directions: "Left side middle.", tags: ["hod", "office", "ise"] },
    { id: "staff-room-left", name: "STAFF ROOM (CSE)", x: 70, y: 1040, w: 180, h: 120, type: "staffroom", description: "CSE Staff workspace", image: "https://placehold.co/600x400?text=Staff+Room+Left", directions: "Left side, lower middle.", tags: ["office", "cse"] },
    ...
    { id: "staff-room-big", name: "STAFF ROOM (ISE)", x: 380, y: 220, w: 200, h: 180, type: "staffroom", description: "Main ISE Staff Room", image: `${IMG_BASE_URL}/apj-block-images/5th-floor/sf(i).jpeg`, directions: "Upper center area.", tags: ["staff", "office", "ise"] },

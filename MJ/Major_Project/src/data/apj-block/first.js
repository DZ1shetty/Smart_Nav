...
export const first = {
  ...
  rooms: [
    ...
    { id: "purchase-section", name: "PURCHASE SECTION", x: 250, y: 1100, w: 180, h: 60, type: "office", description: "Purchase and Procurement Section", image: `${IMG_BASE_URL}/apj-block-images/1st-floor/whatsapp-image-2026-04-27-at-3.04.23-pm.jpeg`, directions: "Lower center left.", tags: ["office", "purchase"] },
    { id: "rajesh-shetty", name: "DR.RAJESH SHETTY CABIN", x: 550, y: 1150, w: 180, h: 80, type: "office", description: "Dr. Rajesh Shetty Office", image: `${IMG_BASE_URL}/apj-block-images/1st-floor/whatsapp-image-2026-04-27-at-3.04.20-pm-1.jpeg`, directions: "Lower center right.", tags: ["office"] },

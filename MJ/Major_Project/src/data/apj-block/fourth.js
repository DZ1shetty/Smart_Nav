...
export const fourth = {
  ...
  bulgeHeight: 500,
  rooms: [
    { id: "staff-room-top-left", name: "STAFF ROOM (CSE)", x: 70, y: 70, w: 180, h: 100, type: "office", description: "CSE Staff workspace", image: `${IMG_BASE_URL}/apj-block-images/4th-floor/sr1.jpeg`, directions: "Top left corner area.", tags: ["staff", "office", "cse"] },
    ...
    { id: "staff-room-top-center", name: "STAFF ROOM (CSE)", x: 350, y: 70, w: 320, h: 90, type: "office", description: "Main CSE Staff Room", image: `${IMG_BASE_URL}/apj-block-images/4th-floor/sr2.jpeg`, directions: "Top center area.", tags: ["staff", "office", "cse"] },
    { id: "staff-room-mid-left", name: "STAFF ROOM", x: 300, y: 220, w: 180, h: 90, type: "office", description: "Staff workspace left", image: `${IMG_BASE_URL}/apj-block-images/4th-floor/sr1.jpeg`, directions: "Upper center section.", tags: ["office"] },
    { id: "staff-room-mid-right", name: "STAFF ROOM", x: 500, y: 220, w: 180, h: 90, type: "office", description: "Staff workspace right", image: `${IMG_BASE_URL}/apj-block-images/4th-floor/sr2.jpeg`, directions: "Upper center section.", tags: ["office"] },

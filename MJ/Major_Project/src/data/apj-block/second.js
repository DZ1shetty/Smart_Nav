...
export const second = {
  ...
  rooms: [
    ...
    { id: "staff-room-top", name: "STAFF ROOM (BT)", x: 320, y: 50, w: 320, h: 80, type: "office", description: "Biotechnology Staff Room", image: `${IMG_BASE_URL}/apj-block-images/2nd-floor/hodbt.jpeg`, directions: "Top center area.", tags: ["staff", "office", "bt"] },
    ...
    { id: "hod-cabin-bt", name: "BT HOD CABIN", x: 30, y: 680, w: 220, h: 140, type: "office", description: "Head of Department - BT", image: `${IMG_BASE_URL}/apj-block-images/2nd-floor/hodbt.jpeg`, directions: "Left side middle.", tags: ["hod", "office", "bt"] },
